...
const Skills = () => {
  return (
    <div className="mx-3 md:mx-4 lg:mx-5 xl:mx-auto mt-20 w-full">
      ...
      <div className="flex items-center md:justify-center gap-7 mr-7">
        ...
        >
          <SiDotnet className="text-violet-500 text-9xl" />
        </div>
        <div
          className="rounded-lg p-2 backdrop-blur-xl backdrop-brightness-75 bg-white/20"
        >
          <SiMicrosoftsqlserver className="text-yellow-600 text-9xl" />
        </div>
        <div
          className="rounded-lg p-2 backdrop-blur-xl backdrop-brightness-75 bg-white/20"
        >
          <AiOutlineJavaScript className="text-yellow-400 text-9xl" />
        </div>
        <div
          className="rounded-lg p-2 backdrop-blur-xl backdrop-brightness-75 bg-white/20"
        >
        ...
        <div
          className="rounded-lg p-2 backdrop-blur-xl backdrop-brightness-75 bg-white/20"
        >
          <FaReact className="text-blue-300 text-9xl" />
        </div>
        <div
          className="rounded-lg  p-2 backdrop-blur-xl backdrop-brightness-75 bg-white/20"
        >
          <SiTailwindcss className="text-sky-700 text-9xl" />
        </div>
      </div>
      </ParallaxText>
