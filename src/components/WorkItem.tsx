    ...
    <div className="border-l-4 border-bluechill-500 p-5 flex md:gap-5 lg:gap-36 flex-col md:flex-row md:items-center md:pb-12 relative transition ease-in-out hover:-translate-y-1 hover:scale-105">
      <div className=" mt-10 md:mt-0 md:w-1/2 lg:w-1/3">
        ...
        <div className="relative">
          <div className="animate-pulse absolute -left-8 text-bluechill-50 text-xl">
            <GoDotFill />
          </div>
          <p className="text-white font-bold">{experience.company}</p>
        </div>
        <div className="absolute top-0 -left-1 bg-bluechill-500  px-2 text-bluechill-50 rounded-md">
          <p>{experience.year}</p>
        </div>
      </div>
